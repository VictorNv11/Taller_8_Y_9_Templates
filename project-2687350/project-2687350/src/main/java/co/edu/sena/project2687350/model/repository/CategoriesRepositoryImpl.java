...
public class CategoriesRepositoryImpl implements Repository<Category> {

    private String sql= null;
    @Override
    public List<Category> listAllObj() throws SQLException{
        sql="select u.category_id, u.category_name from categories_tbl u order by u.category_id, u.category_name";
    ...
    public Category byIdObj (Integer id) throws SQLException{
        sql="select u.category_id, u.category_name from categories_tbl u where u.category_id = ?";
